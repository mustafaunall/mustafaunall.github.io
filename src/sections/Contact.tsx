...
const SOCIALS = [
  {
    label: 'LinkedIn',
    href: 'https://linkedin.com/in/mustafaunall',
    icon: (
  ...
  {
    label: 'GitHub',
    href: 'https://github.com/mustafaunall',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
  ...
  },
  {
    ...
    href: 'https://stackoverflow.com/users/13751229',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
    ...
    <section id="contact" className="py-24 px-6 border-t border-border">
      <div className="container mx-auto max-w-3xl">
        ...
        <p className="text-muted-foreground mb-10 max-w-md leading-relaxed">
          If you have a project in mind, want to collaborate, or just want to talk about tech —
          reach out. I read everything.
        </p>

        <div className="flex flex-wrap gap-3 mb-12">
          <Button asChild>
            <a href="mailto:mustafaunaldev@gmail.com">send an email</a>
          </Button>
          {SOCIALS.map((s) => (
        ...
        <p className="font-mono text-xs text-muted-foreground/50">
          mustafa ünal · {new Date().getFullYear()}
        </p>
      </div>
    </section>
  )
